...
//	String imageName = "";
	 ...
	 * @param img
	 */
	public PhotoViewScreen(Image img) {// System.out.println("PhotoViewScreen.PhotoViewScreen()");
...
/*	public PhotoViewScreen(AlbumData mod, String name) {
	 ...
	 */
	protected void paint(Graphics g) { //System.out.println("PhotoViewScreen.paint()");
	    ...
	    if (image == null) 
	    	System.err.println("PhotoViewScreen::paint(): Image object was null.");
