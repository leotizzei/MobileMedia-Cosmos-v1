...
class AddPhotoToAlbum extends Form {
	...
	protected AddPhotoToAlbum(String title) { 
		super(title);
		//System.out.println("AddPhotoToAlbum.AddPhotoToAlbum()");
	...
	protected String getPhotoName(){ //System.out.println("AddPhotoToAlbum.getPhotoName()");
		return labeltxt.getString();
	}
	
	protected String getPath(){ //System.out.println("AddPhotoToAlbum.getPath()");
