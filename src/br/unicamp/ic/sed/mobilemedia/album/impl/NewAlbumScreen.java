...
class NewAlbumScreen extends Form {
	...
	public NewAlbumScreen(String name) {
		super(name); //System.out.println("NewAlbumScreen.NewAlbumScreen()");
	...
	public NewAlbumScreen(String title, Item[] items) {
		super(title, items);
		//System.out.println("NewAlbumScreen.NewAlbumScreen()");
	}	
	
	/**
	 * @return Returns the new Album Name.
	 */
	public String getAlbumName() { //System.out.println("NewAlbumScreen.getAlbumName()");
